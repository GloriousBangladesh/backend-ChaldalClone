"""
Django settings for clone_backend project.
...
SECRET_KEY = 'django-insecure-i-f$^^da@bg7ivyk6%c+f$p#!mtdmyxk(o6^8_ehtj((=%d4u$'
...
ROOT_URLCONF = 'clone_backend.urls'
...
WSGI_APPLICATION = 'clone_backend.wsgi.application'
